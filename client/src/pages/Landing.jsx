...
export default function Landing() {
  ...
  return (
    <div className="cl">
      ...
      {/* Floating WhatsApp — Nigerian-first: this is where business actually
          talks. Appears once the visitor is past the hero. */}
      <AnimatePresence>
        {pastHero && (
          <motion.a
            className="cl-wa-float"
            href="https://wa.me/2348148128551?text=Hello%20Collarone%20—%20I%27d%20like%20to%20know%20more"
